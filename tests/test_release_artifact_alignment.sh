...
assert_contains "docker-compose.images.yml" 'qdrant:'
...
assert_contains "docker-compose.images.yml" 'QDRANT_HOST=qdrant'
assert_contains "docker-compose.images.yml" 'QDRANT_PORT=6334'
...
echo "Checking release artifact packaging..."
assert_contains ".github/workflows/build.yml" 'docker pull qdrant/qdrant:v1.9.0'
assert_contains ".github/workflows/build.yml" 'qdrant.tar'

echo "Checking release docs..."
assert_contains "README.md" 'docgenvault'
assert_contains "README.md" 'four image tar files'
assert_contains "README.md" '- qdrant'
...
assert_contains "RUN-FROM-ARTIFACT.md" '`qdrant.tar`'
